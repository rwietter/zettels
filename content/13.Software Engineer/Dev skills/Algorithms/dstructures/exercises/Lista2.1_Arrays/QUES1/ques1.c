...
#include <math.h> /* sqrt */
#include "/home/ghost/Downloads/PED/ESTUDAR_PROVA/LISTAS_DE_EXERCÍCIOS/Lista2.1/QUES1/ques1.h"
...
/*
Problema 1
Acrescente novas operações ao TAD ponto, tais como soma e subtração de pontos.
*/
